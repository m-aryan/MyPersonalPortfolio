...
import { getContactContent } from "../utils/content";
...
export const Contact = () => {
    ...
    const socialData = [
                {
            href: contactData.mailURL,
            icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                <path d="M22 4H2C1.44772 4 1 4.44772 1 5V19C1 19.5523 1.44772 20 2 20H22C22.5523 20 23 19.5523 23 19V5C23 4.44772 22.5523 4 22 4ZM12 14L2 8V6L12 12L22 6V8L12 14Z" fill="currentColor" />
            </svg>,
            alt: 'Gmail'
        },
        {
        ...
        {
            href: contactData.mediumURL,
            icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 1043.63 592.71" fill="none">
                <path d="M177.24 148.2c1.92-8.88-2.51-17.81-10.71-22.26L33.11 2.52v-1.26h280.09l216.6 363.88L739.59 1.26h277.82v1.26L917.14 65.24c-6.98 5.32-10.48 14.2-8.86 22.98v445.24c-1.62 8.78 1.88 17.66 8.86 22.98l100.27 63.98v1.26H630.58v-1.26l103.04-64.71c10.3-10.04 10.3-13.16 10.3-28.51V172.34L472.01 590.27h-3.02L217.43 172.34v272.89c-2.83 21.37 4.27 42.95 19.53 58.43l134.22 163.4v1.26H0v-1.26l134.22-163.4c15.11-15.48 21.92-37.06 19.53-58.43V148.2h-1.74z" fill="currentColor" />
            </svg>,
            alt: 'Medium'
        },
    ];
    ...
    return (
        <section
            ...
            id="contact"
        >
            <div className="container mb-8 lg:grid lg:items-stretch">
                ...
                <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
                    ...
                    <p className="text-zinc-400 mt-3 mb-8 lg:max-w-full reveal-up">
                        {contactData.contactMessage}
                    </p>

                    <div className="flex items-center gap-2 mt-auto ml-1">
                        {socialData.map(({ href, icon }, key) => (
                            <a
                                key={key}
                                href={href}
                                target="_blank"
                ...
                <p className="flex justify-center mt-10 text-sm text-zinc-400 items-stretch reveal-up">
                    Developed by Aryan Mane
                </p>
            </div>
        </section>
    );
